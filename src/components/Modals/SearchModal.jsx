...
// import { fetchProductsBySearch } from '../../store/slices/productsSlice';
...
{console.log(product._id,"product.id")}
                      ...
                      <img
    // सबसे सुरक्षित तरीका:
    // 1. जाँच करें कि क्या 'images' मौजूद है।
    // 2. जाँच करें कि क्या पहला एलिमेंट ([0]) मौजूद है।
    // 3. अगर है, तो उसका 'url' उपयोग करें।
    // 4. अगर इनमें से कुछ भी नहीं मिलता, तो एक प्लेसहोल्डर इमेज दिखाएं।
